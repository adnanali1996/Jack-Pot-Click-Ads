...
@section('main-content')
    <div class="page-content-wrapper">
        <div class="page-content">
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <h1 class="bold" style="color: red">Send money Not Found <i class="far fa-smile"></i></h1>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @else
            <h3 class="bold">Send Money View of {{$trans_object->member->first_name }} {{$trans_object->member->last_name }}</h3>
            <div class="row">
                <div class="col-md-12">
